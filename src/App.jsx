...
function App() {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-8">
      ...
      <div className="flex justify-center w-full">
        <div className="grid justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <PortfolioCard img="../img_src/ved_vasudev.jpeg" title="Ved Vasudev Prathisthan" desc="" link="https://youtu.be/pKZ3f8XlhMo?si=q2E7sKo1ezR1Zan9" page="corporate" />
          <PortfolioCard img="../img_src/asahi_india.jpeg" title="Asahi India Glass LTD" desc="" link="https://youtu.be/i3i0L4LdC8M" page="corporate" />
          <PortfolioCard img="../img_src/happy_eggs.jpeg" title="Happy Eggs" desc=""link="https://youtu.be/J212YpeAPUo?si=A1p_AA1yj81PZMpI" page="corporate" />
  ...
  const MusicVideos = () => (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-8">
      ...
      <div className="flex justify-center w-full">
        <div className="grid justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <PortfolioCard img="../img_src/vande_mataram.png" title="Vande Mataram" desc="" link="https://youtu.be/dNmHibwmvqI?si=wxyIJHsY2LggTfkf" page="music" />
          <PortfolioCard img="../img_src/bhakti_geet.png" title="Bhakti Geet" desc="" link="https://youtu.be/rDgTH4Gp3HE?si=tsmh0mvP6JsR6VMY" page="music" />
          <PortfolioCard img="../img_src/gondhal.jpeg" title="Gondhal" desc="" link="https://youtu.be/TcVf62iYbks?si=PuMB7veUTuGpx7Yf" page="music" />
          {/* <PortfolioCard img="https://placehold.co/350x350/333/FFF?text=Film+4" title="Film 4" desc="" /> */}
        </div>
      </div>
    </div>
  ...
  const ShortFilms = () => (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-8">
      ...
      <div className="flex justify-center w-full">
        <div className="grid justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <PortfolioCard img="../img_src/motichor_ke_laddo.png" title="Motichoor Ke Laddoo" desc="" link="https://youtu.be/irysurGDovw?si=BTB2RLiadAo_gM32" page="short" />
          <PortfolioCard img="../img_src/saarthi.png" title="Saarthi" desc="" link="https://youtu.be/xgOMM4izozs?si=tQRsbBV60XYQ_rk0" page="short" />
          <PortfolioCard img="../img_src/tv_2.jpeg" title="TV" desc="" link="" page="short" /> //Link not available
          {/* <PortfolioCard img="https://placehold.co/350x350/333/FFF?text=Film+4" title="Film 4" desc="" /> */}
        </div>
      </div>
    </div>
  ...
  const WebSeries = () => (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-8">
      ...
      <div className="flex justify-center w-full">
        <div className="grid justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <PortfolioCard img="../img_src/mai_bhi_youtuber.png" title="Mai Bhi Youtuber" desc="" link="https://youtube.com/playlist?list=PLsdgdmaYXaR9n1bhQsT1DAZz5Jw2kXAGh&si=Fasfbb0uQ4sPLxec" page="webseries" />
          <PortfolioCard img="../img_src/dverb_archives.png" title="Dverb Archives" desc="" link="https://youtube.com/playlist?list=PL6MF45xwWlcAn3wkG848hjP4jOz9KihQ0&si=MOtiVGmfbEXJ5avb" page="webseries" />
          <PortfolioCard img="../img_src/antarpat.jpeg" title="Antarpat" desc="" link ="https://youtu.be/U_Yme-0BoCw?si=iG2F0tGA9q8wB-bi" page="webseries" />
        </div>
      </div>
    </div>
  );
  const SocialMedia = () => (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-8">
      ...
      <div className="flex justify-center w-full">
        <div className="grid justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <PortfolioCard img="../img_src/the_mad_riyazi.png" title="The Mad Riyazi" desc="" link="https://www.youtube.com/watch?v=dQw4w9WgXcQ" page="socialmedia" />
          <PortfolioCard img="../img_src/firodiya_karanadak.png" title="Firodiya Karanadak" desc="" link="https://www.youtube.com/watch?v=dQw4w9WgXcQ" page="socialmedia" />
          <PortfolioCard img="../img_src/footloose_journeys.png" title="Footloose Journeys" desc="" link="https://www.youtube.com/watch?v=dQw4w9WgXcQ" page="socialmedia" />
          <PortfolioCard img="../img_src/mahua_store.png" title="Mahua Store" desc="" link="https://www.youtube.com/watch?v=dQw4w9WgXcQ" page="socialmedia" />
        </div>
      </div>
    </div>
  );
      ...
      <div className="max-w-4xl mx-auto text-center bg-gray-800 p-8 rounded-lg shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out border border-gray-700">
            <img
              src="../img_src/abhishek_profile.jpg"
              alt="Abhishek Shinde"
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out border border-gray-700">
            <img
              src="../img_src/vedant_profile.jpg"
              alt="Vedant Naik"
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out border border-gray-700">
            <img
              src="../img_src/yogish_profile.png"
              alt="Yogish"
